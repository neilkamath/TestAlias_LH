...
/* package liquid-haskell-test-0.1.0.0 */
#ifndef VERSION_liquid_haskell_test
#define VERSION_liquid_haskell_test "0.1.0.0"
#endif /* VERSION_liquid_haskell_test */
#ifndef MIN_VERSION_liquid_haskell_test
#define MIN_VERSION_liquid_haskell_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_liquid_haskell_test */
...
#define CURRENT_COMPONENT_ID "liquid-haskell-test-0.1.0.0-inplace-liquid-haskell-test"
